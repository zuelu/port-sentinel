...
1. 打开 [Releases](https://github.com/zuelu/port-sentinel/releases/latest)，下载完整的 `PortSentinel-v1.5.1-windows-x64.zip`。
   Open [Releases](https://github.com/zuelu/port-sentinel/releases/latest) and download the complete `PortSentinel-v1.5.1-windows-x64.zip`.
